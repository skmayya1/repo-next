...
const Card = ({ Data }: { Data: IProject | null }) => {
  ...
  return (
    <div className='h-[30vh] border rounded-lg dark:border-zinc-700 border-[#584B53]  flex flex-col items-center justify-center overflow-hidden shadow-md shadow-[#efe6dd1a]'>
      {
        Data ? (
          <div className='h-full w-[95%] flex flex-col justify-around'>
            ...
            <div className="text-sm h-[5%] flex w-full justify-between">
              ...
              <div className="flex  opacity-85  gap-2">
                <a className='hover:scale-105 transition-all ease-in-out duration-150 hover:text-white hover:opacity-100' href={Data.homepage}>
                  <GoLink size={18} />
                </a>
                <a className='hover:scale-105 transition-all ease-in-out duration-150 hover:text-white hover:opacity-100' href={Data.html_url}>
            ...
            <div className="flex w-full gap-1 h-[10%]">
              ...
              <span className='w-fit border dark:border-zinc-700 border-[#584B53] h-fit py-0.5 rounded-lg flex items-center gap-1 px-2 shadow-md shadow-[#efe6dd1a]z'><CiStar/>{formatNumber(Data.stargazers_count)}</span>
            </div>
